...
RUN mkdir -p ~/usr/share/nginx/html && cd ~/usr/share/nginx/html

RUN apt-get update && apt-get -y install curl && apt-get -y install unzip 

CMD /bin/bash

RUN curl -L -o master.zip "https://github.com/remylavergne/personal-website/archive/master.zip"

RUN unzip master.zip

RUN cd personal-website-master/
